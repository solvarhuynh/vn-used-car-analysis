# Clean Carpla raw data according to rule/clean_rule.md.
# Output: data/data_carpla_clean.csv
...
INPUT_FILE <- "data/data_carpla_raw.csv"
OUTPUT_FILE <- "data/data_carpla_clean.csv"
DISPLAY_NAME <- "Carpla"
