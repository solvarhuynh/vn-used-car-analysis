# Clean Oto.com.vn raw data according to rule/clean_rule.md.
# Output: data/data_oto_clean.csv
...
SCRIPT_NAME <- "clean_oto.R"
INPUT_FILE <- "data/data_oto_raw.csv"
OUTPUT_FILE <- "data/data_oto_clean.csv"
