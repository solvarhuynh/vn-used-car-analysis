# Clean Chợ Tốt raw data according to rule/clean_rule.md.
# Output: data/data_chotot_clean.csv
...
INPUT_FILE <- "data/data_chotot_raw.csv"
OUTPUT_FILE <- "data/data_chotot_clean.csv"
